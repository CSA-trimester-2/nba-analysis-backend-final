...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").allowedOrigins("https://nighthawkcoders.github.io", "http://localhost:4000", "http://127.0.0.1:4100", "https://vardaansinha.github.io", "http://localhost:4200", "http://jishnus420.github.io");
    }
